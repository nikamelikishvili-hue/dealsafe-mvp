  ...
  return <section className="shipping-panel no-print">
    ...
    <div className="delivery-address-section">
      ...
      {deal.viewerRole==='buyer'&&(!delivery||editingAddress)&&<form className="delivery-address-form" onSubmit={saveAddress}>
        ...
        <label>{t('Apartment / Suite / Unit (optional)')}<input maxLength={100} autoComplete="address-line2" value={address.addressLine2} onChange={e=>setAddress({...address,addressLine2:e.target.value})} placeholder={t('Apt 4B, Suite 210, Unit 3')}/></label>
