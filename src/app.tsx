...
export function App() {
  ...
  return <div className={`app view-${view}`}>
    ...
    <header className="site-header"><div className="header-inner">
      <div className="header-brand-group"><button className="brand" onClick={()=>goHomeSection()}><span><ShieldCheck size={21}/></span>DealSafe</button><span className="beta">Launching in the U.S.</span></div>
