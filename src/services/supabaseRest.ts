...
export interface AdminReport { report_id:string;deal_id:string;public_id:string;title:string;reason:string;report_status:'open'|'reviewed'|'dismissed';created_at:string;reporter_name:string;seller_name:string;resolution_note:string|null }
