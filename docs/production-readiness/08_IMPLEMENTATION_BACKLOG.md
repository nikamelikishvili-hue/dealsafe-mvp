...
| UX-002 | P0 | **In progress locally:** shared feedback, field-error, async-state, and validation-summary contracts now govern account/recovery announcements plus creation, meeting, shipping, and support-case validation and recovery; remaining workflow migrations remain | Component tests cover keyboard, focus, names, errors, loading, touch targets |
