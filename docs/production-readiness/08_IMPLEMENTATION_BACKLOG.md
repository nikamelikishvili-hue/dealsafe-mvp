...
| UX-002 | P0 | **In progress locally:** shared feedback and field-error primitives now govern account/recovery announcements and password-reset validation, including descriptive relationships and deterministic focus recovery; loading, retry, validation-summary, and remaining workflow migrations remain | Component tests cover keyboard, focus, names, errors, loading, touch targets |
