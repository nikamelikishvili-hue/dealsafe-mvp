...
2. Copy `.env.example` to `.env` and add the project URL and anonymous key.
3. Replace `src/services/demoRepository.ts` with a Supabase implementation of `DealRepository`.
